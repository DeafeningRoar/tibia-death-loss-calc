        ...
        return(
            <div id="resultsTable">
                ...
                <div className="form-row">
                    ...
                    <input className="form-control col-md-8" type="text" value={this.state.fbExpLoss} readOnly/>
                </div>
                <div className="form-row">
                    <div className="form-group col-md-4">
                        <label >No Blessings Experience Loss</label>
                    </div>
                    <input className="form-control col-md-8" type="text" value={this.state.nFbExpLoss} readOnly/>
                </div>
                <div className="form-row">
                    <div className="form-group col-md-4">
                        <label>Hardcore All Blessings Experience Loss</label>
                    </div>
                    <input className="form-control col-md-8" type="text" value={this.state.hcfbExpLoss} readOnly/>
                </div>
                <div className="form-row">
                    <div className="form-group col-md-4">
                        <label >Hardcore No Blessings Experience Loss</label>
                    </div>
                    <input className="form-control col-md-8" type="text" value={this.state.hcNfbExpLoss} readOnly/>
                </div>
            </div>
        );
    }
