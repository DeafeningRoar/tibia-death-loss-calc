...
var baseExpLoss = function baseExpLoss(level, totalExp) {
    level = Number(level);
...
var ResultsTable = function (_Component) {
    ...
    _createClass(ResultsTable, [{
        ...
        value: function componentWillReceiveProps(nextProps) {
            ...
            var baseLoss = _calculations2.default.baseExpLoss(nextProps.level, totalExp);
            ...
            var regularLoss = {
                blessExpLoss: (0, _numeral2.default)(blessExpLoss).format('0,0'),
                noBlessExpLoss: (0, _numeral2.default)(noBlessExpLoss).format('0,0')
            };

            var hcLoss = {
                blessExpLoss: (0, _numeral2.default)(hcBlessExpLoss).format('0,0'),
                noBlessExpLoss: (0, _numeral2.default)(hcNoBlessExpLoss).format('0,0')
            };

            this.setState({
                totalExp: (0, _numeral2.default)(Math.round(totalExp)).format('0,0'),
                stats: {
                    hitpoints: (0, _numeral2.default)(stats.hitpoints).format('0,0'),
                    manapoints: (0, _numeral2.default)(stats.manapoints).format('0,0'),
                    capacity: (0, _numeral2.default)(stats.capacity).format('0,0')
                },
                regularLoss: regularLoss,
                hcLoss: hcLoss,
                level: (0, _numeral2.default)(nextProps.level).format('0,0'),
