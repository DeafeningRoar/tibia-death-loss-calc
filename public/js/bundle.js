...
var _numeral = __webpack_require__(71);
...
var calculateStats = function calculateStats(level, vocation) {
    ...
    var results = {
        hitpoints: (0, _numeral2.default)(hitpoints).format('0,0'),
        manapoints: (0, _numeral2.default)(manapoints).format('0,0'),
        capacity: (0, _numeral2.default)(capacity).format('0,0')
    };

    return results;
};

var baseExperienceLoss = function baseExperienceLoss(level, totalExp) {
    var result = level < 25 ? 0.1 * totalExp : (level + 50) / 100 * 50 * (Math.pow(level, 2) - 5 * level + 8);
    return result;
};

var totalExperience = function totalExperience(level) {
...
var expLossCustomBless = function expLossCustomBless(level, base, promotion, hc, bless) {
    var reduc = hc ? 1.16 : 1;
...
var totalResults = function totalResults(level, voc, promo) {
    level = Number(level);
    ...
    if (level <= 0) {
        ...
        return {
            stats: stats,
            totalExp: (0, _numeral2.default)(totalExp).format('0,0'),
            fbExpLoss: (0, _numeral2.default)(fbExpLoss).format('0,0'),
            nFbExpLoss: (0, _numeral2.default)(nFbExpLoss).format('0,0'),
            hcfbExpLoss: (0, _numeral2.default)(hcfbExpLoss).format('0,0'),
            hcNfbExpLoss: (0, _numeral2.default)(hcNfbExpLoss).format('0,0')
        };
    }
};

exports.default = { totalResults: totalResults, expLossCustomBless: expLossCustomBless, baseExperienceLoss: baseExperienceLoss, defaultValues: defaultValues };
...
var Calculator = function (_Component) {
    ...
    _createClass(Calculator, [{
        ...
        value: function renderResults() {
            return _react2.default.createElement(_results2.default, { level: this.state.level, vocation: this.state.vocation, promotion: this.state.promotion });
        }
    }, {
        key: 'renderForm',
        value: function renderForm() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        { className: 'form-group row col-md-12 d-flex justify-content-center' },
                        _react2.default.createElement(
                            'label',
...
var ResultsTable = function (_Component) {
    ...
    function ResultsTable(props) {
        ...
        _this.state = _extends({}, _calculations2.default.defaultValues);
        return _this;
    }
    ...
    _createClass(ResultsTable, [{
        ...
        value: function componentWillReceiveProps(nextProps) {
            var totalResults = _calculations2.default.totalResults(nextProps.level, nextProps.vocation, nextProps.promotion);

            this.setState(_extends({}, totalResults));
        }
    }, {
        key: 'render',
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement('input', { className: 'form-control col-md-8', type: 'text', value: this.state.fbExpLoss, readOnly: true })
                ),
                _react2.default.createElement(
                    'div',
                    { className: 'form-row' },
                    ...
                    _react2.default.createElement('input', { className: 'form-control col-md-8', type: 'text', value: this.state.nFbExpLoss, readOnly: true })
                ),
                _react2.default.createElement(
                    'div',
                    { className: 'form-row' },
                    ...
                    _react2.default.createElement('input', { className: 'form-control col-md-8', type: 'text', value: this.state.hcfbExpLoss, readOnly: true })
                ),
                _react2.default.createElement(
                    'div',
                    { className: 'form-row' },
                    ...
                    _react2.default.createElement('input', { className: 'form-control col-md-8', type: 'text', value: this.state.hcNfbExpLoss, readOnly: true })
                )
            );
        }
    }]);
